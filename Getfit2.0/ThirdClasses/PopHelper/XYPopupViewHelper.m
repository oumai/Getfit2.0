...
@property (nonatomic, strong) XYPopupViewHelperNormalBlock dismissBlock;
@property (nonatomic, strong) XYPopupViewHelperNormalBlock showAnimation;
@property (nonatomic, strong) XYPopupViewHelperNormalBlock dismissAnimation;
     ...
     dismissBlock:(XYPopupViewHelperNormalBlock)dismissBlock
{
    ...
    UIViewController *vc = [MBHUDHelper topMostController];
    ...
    if (IOS8_OR_LATER) {
        _popupVIew.center = [_popupVIew superview].center;
    } else {
        CGPoint point = [_popupVIew superview].center;
        _popupVIew.center = CGPointMake(point.y, point.x);
    }
