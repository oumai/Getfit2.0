...
{
    if (!_arrowImage) {
        arrowImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:MJRefreshSrcName(@"arrow.png")]];
...
- (void)layoutSubviews
{
    ...
    if (_stateImageV == nil) {
        self.stateImageV = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 40, 40)];
        self.stateImageV.center = CGPointMake(self.width/2 - 20, self.mj_h * 0.5);
    ...
    self.arrowImage.center = CGPointMake(self.width/2 - 20, self.mj_h * 0.5);
    ...
    switch (state) {
        ...
        case MJRefreshHeaderStatePulling: {
            [UIView animateWithDuration:MJRefreshFastAnimationDuration animations:^{
                ...
                self.titleLabel.text = KK_Text(@"Release Refresh");
            }];
            break;
        }
